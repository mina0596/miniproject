...
<% 
		System.out.println(S_ID + "<-- S_ID post_contents_form.jsp");
...
%>
    ...
    <button type="button" onclick="location.href='post_contents_update_form.jsp?post_code=<%= post_code%>'">수정</button>
    <button type="button" onclick="location.href='post_contents_delete.jsp?post_code=post_code'">삭제</button>
